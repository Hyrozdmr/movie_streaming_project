    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watchlist', models.ManyToManyField(related_name='users_watching', to='movies.movie')),
                ('watchlist_tv', models.ManyToManyField(related_name='users_watching', to='movies.tvshow')),
            ],
            options={
                'verbose_name': 'user',

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watchlist', models.ManyToManyField(related_name='users_movie_watchlist', to='movies.movie')),
                ('watchlist_tv', models.ManyToManyField(related_name='users_tv_watchlist', to='movies.tvshow')),
            ],
            options={
                'verbose_name': 'user',
